  ...
  return (
    <div className={isSearch ? 'action-bar ac-search' : 'action-bar'}>
      <div className="col1">
        {(() => {
          if (!isSearch) {
            ...
            return (
              <span className="menu" onClick={onCancel}>
                <MdClose fontSize="25px" color="#ffffff" />
              </span>
            );
          }
        })()}
      ...
      <div className={isSearch ? 'col3 search' : 'col3'}>
        <span onClick={searchClick} className="search-btn">
          <IosSearch fontSize="25px" color="#ffffff" />
        </span>
        {(() => {
          if (isSearch) {
            return (
